...
CREATE TABLE "choice_fact" (
	"choice_fact_id" integer PRIMARY KEY,
	"game_id" varchar NOT NULL,
	"run_id" varchar NOT NULL,
...
CREATE UNIQUE INDEX "boss_game_id_name_norm_idx" ON "boss" ("game_id","name_norm");
CREATE UNIQUE INDEX "boss_pkey" ON "boss" ("boss_id");
CREATE INDEX "boss_summary_game_id_boss_id_idx" ON "boss_summary" ("game_id","boss_id");
...
ALTER TABLE "boss_summary" ADD CONSTRAINT "boss_summary_boss_id_fkey" FOREIGN KEY ("boss_id") REFERENCES "boss"("boss_id");
...
ALTER TABLE "choice_fact" ADD CONSTRAINT "choice_fact_event_id_fkey" FOREIGN KEY ("choice_fact_id") REFERENCES "event"("event_id");
